          ...
          <div className="relative order-2 lg:order-1">
            ...
            >
              <img 
                ...
                alt="Yashasvi Khatri" 
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover object-[center_10%] filter grayscale group-hover:grayscale-0 transition-all duration-700 scale-100 group-hover:scale-105"
              />
